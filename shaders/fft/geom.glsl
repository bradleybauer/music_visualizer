...
void main() {
	...
	// LOG(FFT)
	// P0 = vec2(t0*2.-1., log2(20.*fl0+0.01)/6.0-.5);
	// P1 = vec2(t1*2.-1., log2(20.*fl1+0.01)/6.0-.5);
	// quad(P0, P1, t0, t1);

	// SQRT(FFT)
	P0 = vec2(t0*2.-1., 2.8*sqrt(40.*fl0)/23.0-.73);
	P1 = vec2(t1*2.-1., 2.8*sqrt(40.*fl1)/23.0-.73);
	quad(P0, P1, t0, t1);
